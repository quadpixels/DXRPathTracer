...
protected:
    ...
    CompiledShaderPtr wavefrontTraceHitsCSVariants[6];
    CompiledShaderPtr wavefrontShadeHitsCSVariants[6];
    CompiledShaderPtr wavefrontTraceShadowsCSVariants[6];
    CompiledShaderPtr wavefrontPersistentTraceShadeCSVariants[6];
    CompiledShaderPtr wavefrontPersistentTraceShadowsCSVariants[6];
    CompiledShaderPtr persistentWarpsPathTraceCSVariants[6];
    CompiledShaderPtr wavefrontCountReorderBinsCSVariants[6];
    CompiledShaderPtr wavefrontScatterReorderedRaysCSVariants[6];
    ...
    ID3D12PipelineState* wavefrontTraceHitsPSOVariants[6] = { };
    ID3D12PipelineState* wavefrontShadeHitsPSOVariants[6] = { };
    ID3D12PipelineState* wavefrontTraceShadowsPSOVariants[6] = { };
    ID3D12PipelineState* wavefrontPersistentTraceShadePSOVariants[6] = { };
    ID3D12PipelineState* wavefrontPersistentTraceShadowsPSOVariants[6] = { };
    ID3D12PipelineState* persistentWarpsPathTracePSOVariants[6] = { };
    ID3D12PipelineState* wavefrontCountReorderBinsPSOVariants[6] = { };
    ID3D12PipelineState* wavefrontScatterReorderedRaysPSOVariants[6] = { };
