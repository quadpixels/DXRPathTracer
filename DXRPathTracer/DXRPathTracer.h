...
protected:
    ...
    CompiledShaderPtr wavefrontTraceHitsCSVariants[8];
    CompiledShaderPtr wavefrontShadeHitsCSVariants[8];
    ...
    ID3D12PipelineState* wavefrontTraceHitsPSOVariants[8] = { };
    ID3D12PipelineState* wavefrontShadeHitsPSOVariants[8] = { };
